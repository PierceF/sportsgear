...
deal5 = Deal.create!(item_id: 6, user_id: 2, status: 'ongoing', duration: 2, start_date: Date.today - 2, end_date: Date.today - 1)

deal6 = Deal.create!(item_id: 2, user_id: 1, status: 'ongoing', duration: 2, start_date: Date.today, end_date: Date.today + 2)
